...
const form = useForm<z.infer<typeof formSchema>>({
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    fetch("http://localhost:3030/users",{
        ...
        body: JSON.stringify({email:values.email,password:values.password,name:values.name}) // include, *same-origin, omit
  ...
  return (
   ...
   <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-7 w-6/12 p-10 pt-0">
        <FormField
